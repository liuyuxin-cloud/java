...
public class Fourth {
    public static void main(String [] args){
        WuMingFen f1 = new WuMingFen("牛肉",5,true);
        f1.check();
    }
}
class WuMingFen{
    ...
    int quantity;
    boolean likeSoup;
    public WuMingFen(String n,int x,boolean z){
        theMa = n;
        quantity = x;
        likeSoup = z;
    }
    public WuMingFen(String n,int x){
        theMa = n;
        quantity = x;
    }
    public WuMingFen(String n,boolean z){
        theMa = n;
        likeSoup = z;
    }
    public void check(){
        System.out.println("面码 " + theMa + " 粉的分量 " + quantity + " 是否带汤 " + likeSoup );
    }
